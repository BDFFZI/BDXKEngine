...
#include "Core/Runtime/Platform/GL/State/Blend.h"
#include "Core/Runtime/Platform/GL/State/Cull.h"
#include "Core/Runtime/Platform/GL/State/ZTest.h"
...
namespace BDXKEngine
{
    ...
    private:
        struct Parameters
        {
            Vector4 float0_3 = Vector4{0, 0.5f, 0, 0}; //x:metallicFactor,y:smoothnessFactor
            Vector4 float4_7;
            Vector4 vector0 = Vector4{Color::white}; //albedoFactor
            Vector4 vector1;
            Vector4 vector2;
            Vector4 vector3;
            Vector4 vector4;
            Vector4 vector5;
            Matrix4x4 matrix0 = Matrix4x4::identity; //objectToWorld TODO 这样将无法进行图形批处理
            Matrix4x4 matrix1;
            Matrix4x4 matrix2;
            Matrix4x4 matrix3;
        ...
        ObjectPtr<Texture2D> texture2D1; //r:metallic,a:smoothness
        ObjectPtr<Texture2D> texture2D2; //normal
