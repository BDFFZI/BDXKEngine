...
#include "Core/Runtime/Platform/Window/Cursor.h"
...
namespace BDXKEditor
{
    ...
    void CameraController::OnUpdate()
    {
        ...
        if ((isControlling = ImGui::IsMouseDown(ImGuiMouseButton_Right)))
        {
            ...
            const Vector2 mouseMoveDelta = Input::GetMouseMoveDeltaReal();
    ...
    {
        gameObject = GameObject::Create("EditorSceneCamera", GetGameObject(), Scene::GetDurableScene());
        ...
        editorCamera->SetNearClipPlane(0.01f);
    }
