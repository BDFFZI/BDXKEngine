...
// You are totally free to apply whatever GameObjectation matrix to want to the data (depending on the use of the GameObjectation you may want to apply it to ClipRect as well!)
