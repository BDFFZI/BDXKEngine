...
namespace BDXKEngine
{
    ...
    public:
        ...
        static Object* GetCreator(const std::string& typeID);

        //希望物体能参与序列化则必须要注册Creator
        template <typename TObject>
        static void SetCreator()
        {
            creators[ParseTypeID<TObject>().c_str()] = [] { return Object::Create<TObject>(); };
        }
    ...
    private:
        static std::unordered_map<std::string, std::function<Object*()>> creators;
