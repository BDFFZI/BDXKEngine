...
namespace BDXKEngine
{
    ...
    {
    public:
        static ObjectSerializer<JsonImporter, JsonExporter> GetJsonSerializer();
        static ObjectSerializer<BinaryImporter2, BinaryExporter2> GetBinarySerializer();
        ...
        template <typename TObject>
        static ObjectPtr<TObject> Load(const std::string& path, Serializer& serializer, bool instantiate = true)
        {
