...
namespace BDXKEditor
{
    ObjectPtr<GameObject> GameObjectMenu::NewGameObject(const char* name)
    {
        ...
        return gameObject.IsNotNull() ? GameObject::Create(name, gameObject) : GameObject::Create(name);
    }
    ...
    {
        ObjectPtr<GameObject> gameObject = NewGameObject("Camera");
    ...
    {
        const ObjectPtr<GameObject> gameObject = NewGameObject(name);
