...
{
    ObjectPtr<Texture2D> Texture2D::Create(const Color color)
    {
        ...
        AwakeObject(texture2d);

        return texture2d;
    }
    ObjectPtr<Texture2D> Texture2D::Create(const int widthf, const int heightf, const TextureFormat textureFormat)
    {
        ObjectPtr texture2d = new Texture2D{};
    ...
    ObjectPtr<Texture2D> Texture2D::Create(const int widthf, const int heightf, const TextureFormat textureFormat, const char* pixels,
