...
{
    void JsonWriter::TransferJson(const std::string key, std::string& value)
    {
    ...
    void JsonWriter::TransferGuid(const xg::Guid& guid)
    {
    ...
    {
        SetTransfer<int>([this](const int& value) { TransferInt(value); });
        SetTransfer<float>([this](const float& value) { TransferFloat(value); });
        SetTransfer<bool>([this](const bool& value) { TransferBool(value); });
        ...
        SetTransfer<Vector2>([this](const Vector2& value) { TransferVector2(value); });
        SetTransfer<Vector3>([this](const Vector3& value) { TransferVector3(value); });
        SetTransfer<Vector4>([this](const Vector4& value) { TransferVector4(value); });
        SetTransfer<Matrix4x4>([this](const Matrix4x4& value) { TransferMatrix4x4(value); });
        SetTransfer<Color>([this](const Color& value) { TransferColor(value); });
        SetTransfer<Rect>([this](const Rect& value) { TransferRect(value); });

        SetTransfer<unsigned int>([this](const unsigned int& value) { GetCurrentNode().SetUint(value); });
        SetTransfer<size_t>([this](const size_t& value) { GetCurrentNode().SetUint64(value); });
    }
}
